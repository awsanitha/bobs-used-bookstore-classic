...
{
    /// <summary>
    /// Seeds the database with initial reference data and books if empty.
    /// Call SeedAsync from application startup after EnsureCreated.
    /// </summary>
    public static class BookstoreDbSeeder
    {
